...
public class AppController extends Application {
    private final String TAG = com.dung.gedung.configfile.AppController.class.getSimpleName();

    private static com.dung.gedung.configfile.AppController instance;

    RequestQueue mRequest;

    public static com.dung.gedung.configfile.AppController getInstance() {
        return instance;
    }
